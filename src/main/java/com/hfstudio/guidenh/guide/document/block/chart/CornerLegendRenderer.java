...
public class CornerLegendRenderer {
    ...
    /**
     * Primitive-pipeline variant of {@link #render}: identical layout logic, but emits
     * {@link GuideRenderPrimitive}s into {@code c} and measures through {@link GuideText}.
     */
    public static void emit(PrimitiveCollector c, LytRect plotRect, List<CornerLegendEntry> entries,
        ...
        c.emit(new GuideRenderPrimitive.DrawBorder(x, y, width, height, 1, 1, 1, 1, 0x66FFFFFF));
    ...
    /** {@link GuideText}-based variant of {@link #ellipsize(RenderContext, String, int)}. */
