...
public final class LayoutInput extends Table {
  ...
  public com.hfstudio.guidenh.guide.layout.flatbuffers.FlatNode nodes(com.hfstudio.guidenh.guide.layout.flatbuffers.FlatNode obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public com.hfstudio.guidenh.guide.layout.flatbuffers.FlatNode.Vector nodesVector(com.hfstudio.guidenh.guide.layout.flatbuffers.FlatNode.Vector obj) { int o = __offset(8); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public static void startLayoutInput(FlatBufferBuilder builder) { builder.startTable(3); }
