...
public class FlowchartEdge {
    ...
    public FlowchartEdge(String from, String to, @Nullable String label, MermaidEdgeStyle style,
        boolean arrowFwd, boolean arrowRev, MermaidArrowHead forwardHead, MermaidArrowHead reverseHead,
        @Nullable String edgeId, int length) {
    ...
    public boolean isArrowFwd() { return arrowFwd; }
    public boolean isArrowRev() { return arrowRev; }
    public MermaidArrowHead getForwardHead() { return forwardHead; }
    public MermaidArrowHead getReverseHead() { return reverseHead; }
