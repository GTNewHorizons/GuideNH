...
public class GuideScreenEditorConflictPrompt extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(fontRendererObj, title, this.width / 2, baseY + 12, ColorUtils.TEXT.getColor());
        fontRendererObj.drawSplitString(message, baseX + 12, baseY + 34, PROMPT_WIDTH - 24, ColorUtils.TEXT_MUTED.getColor());
